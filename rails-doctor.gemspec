...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/rails-doctor/rails-doctor"
  spec.license = "MIT"
  spec.required_ruby_version = ">= 3.2"

  spec.metadata = {
    "bug_tracker_uri" => "https://github.com/rails-doctor/rails-doctor/issues",
    "changelog_uri" => "https://github.com/rails-doctor/rails-doctor/blob/main/CHANGELOG.md",
    "documentation_uri" => "https://github.com/rails-doctor/rails-doctor/tree/main/docs",
    "homepage_uri" => "https://rails-doctor.dev",
    "source_code_uri" => "https://github.com/rails-doctor/rails-doctor",
